...
Read more in [Core Concepts]({{ '/docs/core-concepts/' | relative_url }}).
...
Read more in [Layouts]({{ '/docs/layouts/' | relative_url }}).
...
Read more in [Components]({{ '/docs/components/' | relative_url }}).
...
Read more in [Themes]({{ '/docs/themes/' | relative_url }}).
